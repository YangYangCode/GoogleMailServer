...
/**
 GET / hash / compare 得到hash_compare.jsp
 +----------+----------+
 | username |		   | <- input
 +----------+----------+
 | password |		   | <- input
...
public class HashCompareServlet extends HttpServlet {
	...
	static {
		users.put("john", "A6xnQhbz4Vx2HuGl4lXwZ5U2I8iziLRFnhP5eNfIRvQ=");	// 密碼1234(不含鹽)
		users.put("mary", "+GOLl5svT3k92229GX4O4lp6bqMrCuIvXjxdEZ2DnnU=");	// 密碼5678(不含鹽)
	}
